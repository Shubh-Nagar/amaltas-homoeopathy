...
const STAFF = [
  // ── Administration ────────────────────────────────────────────────────────
  { sn: 1,  name: 'Dr. Yogendra Bhadoriya',      designation: 'Principal / Medical Superintendent', qual: 'MD',                     type: 'FT',      doj: '22-02-2022', category: 'Administration' },
  // ── Specialists ──────────────────────────────────────────────────────────
  { sn: 2,  name: 'Dr. Raghvendra Pratap Singh', designation: 'Surgeon',                    qual: 'MS',                              type: 'FT',      doj: '26-12-2024', category: 'Specialists' },
  { sn: 3,  name: 'Dr. Kirti Hada',              designation: 'Consultant / Pathologist',   qual: 'MD',                              type: 'FT',      doj: '29-04-2025', category: 'Specialists' },
  { sn: 4,  name: 'Dr. Afjal Patel',             designation: 'General Physician',          qual: 'MD',                              type: 'FT',      doj: '19-01-2026', category: 'Specialists' },
  { sn: 5,  name: 'Dr. Tanya Joshi',             designation: 'Obst. & Gynaecologist',      qual: 'Diplomate N.B. (Obst. & Gynae.)', type: 'FT',      doj: '13-01-2026', category: 'Specialists' },
  { sn: 6,  name: 'Dr. Amey Narkhede',           designation: 'Radiologist',                qual: 'Radiologist',                     type: 'On Call', doj: '02-03-2023', category: 'Specialists' },
  { sn: 7,  name: 'Dr. Soniya Sharma',           designation: 'Ophthalmologist',            qual: 'MS',                              type: 'On Call', doj: '02-06-2023', category: 'Specialists' },
  { sn: 8,  name: 'Dr. Neha Kakani',             designation: 'Consultant',                 qual: 'MD',                              type: 'On Call', doj: '01-03-2022', category: 'Specialists' },
  { sn: 9,  name: 'Dr. Jyoti Yadav',             designation: 'Anesthesiologist',           qual: 'Diploma',                         type: 'On Call', doj: '06-03-2023', category: 'Specialists' },
  { sn: 10, name: 'Dr. Yogesh Loksh',            designation: 'Dentist',                    qual: 'BDMS',                            type: 'On Call', doj: '13-03-2023', category: 'Specialists' },
  // ── Medical Officers ──────────────────────────────────────────────────────
  { sn: 11, name: 'Dr. Anjali Soni',             designation: 'Resident Medical Officer',   qual: 'BHMS',                            type: 'FT',      doj: '03-07-2024', category: 'Medical Officers' },
  { sn: 12, name: 'Dr. Archana Malviya',         designation: 'Resident Medical Officer',   qual: 'BHMS',                            type: 'FT',      doj: '02-09-2024', category: 'Medical Officers' },
  { sn: 13, name: 'Dr. Sanjay Singh Solanki',    designation: 'Medical Officer',            qual: 'BHMS',                            type: 'FT',      doj: '08-09-2025', category: 'Medical Officers' },
  { sn: 14, name: 'Dr. Mahima Patidar',          designation: 'Medical Officer',            qual: 'BHMS',                            type: 'FT',      doj: '29-05-2023', category: 'Medical Officers' },
  { sn: 15, name: 'Dr. Mohit Patel',             designation: 'Medical Officer',            qual: 'BHMS',                            type: 'FT',      doj: '01-04-2025', category: 'Medical Officers' },
  { sn: 16, name: 'Dr. Yashfeen Qureshi',        designation: 'Medical Officer',            qual: 'BHMS',                            type: 'FT',      doj: '01-01-2026', category: 'Medical Officers' },
  { sn: 17, name: 'Dr. Dheeraj Gurjar',          designation: 'Medical Officer',            qual: 'BHMS',                            type: 'FT',      doj: '24-01-2026', category: 'Medical Officers' },
  // ── House Physicians ──────────────────────────────────────────────────────
  { sn: 18, name: 'Dr. Love Mehra',              designation: 'House Physician',            qual: 'BHMS',                            type: 'FT',      doj: '09-03-2023', category: 'House Physicians' },
  { sn: 19, name: 'Dr. Kirti Soni',              designation: 'House Physician',            qual: 'BHMS',                            type: 'FT',      doj: '31-03-2026', category: 'House Physicians' },
  { sn: 20, name: 'Dr. Shivani Vaidya',          designation: 'House Physician',            qual: 'BHMS',                            type: 'FT',      doj: '02-12-2024', category: 'House Physicians' },
  { sn: 21, name: 'Dr. Harshita Gupta',          designation: 'House Physician',            qual: 'BHMS',                            type: 'FT',      doj: '03-07-2025', category: 'House Physicians' },
  // ── Allied Health ─────────────────────────────────────────────────────────
  { sn: 22, name: 'Dr. Anjali Mehta',            designation: 'Physiotherapist',            qual: 'BHMS',                            type: 'FT',      doj: '21-01-2021', category: 'Allied Health' },
  { sn: 23, name: 'Sanjay Rambhole',             designation: 'Yoga Expert',                qual: 'DYED',                            type: 'FT',      doj: '12-01-2021', category: 'Allied Health' },
  { sn: 24, name: 'Namrta Vaidhya',              designation: 'Dietician',                  qual: 'MHSC',                            type: 'FT',      doj: '06-09-2025', category: 'Allied Health' },
  // ── Nursing ───────────────────────────────────────────────────────────────
  { sn: 25, name: 'Neha Minhas',                 designation: 'Nursing Incharge',           qual: 'BSc Nursing',                     type: 'FT',      doj: '13-12-2024', category: 'Nursing' },
  { sn: 26, name: 'Shakuntala Dhurvey',          designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '11-02-2025', category: 'Nursing' },
  { sn: 27, name: 'Ravindra',                    designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '09-01-2026', category: 'Nursing' },
  { sn: 28, name: 'Rinku Dawar',                 designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '12-08-2025', category: 'Nursing' },
  { sn: 29, name: 'Rahul Vishwakarma',           designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '11-02-2025', category: 'Nursing' },
  { sn: 30, name: 'Sona Verma',                  designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '24-07-2024', category: 'Nursing' },
  { sn: 31, name: 'Pawan Saini',                 designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '20-07-2024', category: 'Nursing' },
  { sn: 32, name: 'Deepika Damor',               designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '08-08-2024', category: 'Nursing' },
  { sn: 33, name: 'Neha Khobragade',             designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '16-06-2026', category: 'Nursing' },
  { sn: 34, name: 'Sundar Singad',               designation: 'Nursing Staff',              qual: 'GNM',                             type: 'FT',      doj: '16-06-2026', category: 'Nursing' },
  // ── Support Staff ─────────────────────────────────────────────────────────
  { sn: 35, name: 'Rajshree Parmar',             designation: 'Pharmacist',                 qual: 'BSc',                             type: 'FT',      doj: '06-11-2024', category: 'Support Staff' },
  { sn: 36, name: 'Shivani Sisodiya',            designation: 'Pharmacist',                 qual: 'B.Com',                           type: 'FT',      doj: '28-10-2023', category: 'Support Staff' },
  { sn: 37, name: 'Reshma Khan',                 designation: 'Pharmacist',                 qual: 'B.Com',                           type: 'FT',      doj: '20-11-2024', category: 'Support Staff' },
  { sn: 38, name: 'Alkesh Dhankani',             designation: 'Lab Technician',             qual: 'DMLT',                            type: 'FT',      doj: '24-10-2020', category: 'Support Staff' },
  { sn: 39, name: 'Hariom Patidar',              designation: 'Pathology Assistant',        qual: 'BMLT',                            type: 'FT',      doj: '20-04-2024', category: 'Support Staff' },
  { sn: 40, name: 'Sanjay Singh Tomar',          designation: 'X-Ray Technician',           qual: 'Diploma X-Ray & ECG',             type: 'FT',      doj: '25-10-2020', category: 'Support Staff' },
  { sn: 41, name: 'Rajkumar Navrang',            designation: 'X-Ray Attendant',            qual: 'BSc',                             type: 'FT',      doj: '12-12-2024', category: 'Support Staff' },
  { sn: 42, name: 'Shekhar Patel',               designation: 'OT Technician',              qual: 'BSc',                             type: 'FT',      doj: '20-07-2022', category: 'Support Staff' },
  { sn: 43, name: 'Jaswant Singh',               designation: 'PRO',                        qual: 'BA',                              type: 'FT',      doj: '04-11-2024', category: 'Support Staff' },
  { sn: 44, name: 'Abhishek Parmar',             designation: 'Store Keeper',               qual: 'BA',                              type: 'FT',      doj: '16-07-2025', category: 'Support Staff' },
  { sn: 45, name: 'Sushma Bhadoriya',            designation: 'Clerk cum Receptionist',     qual: 'BA',                              type: 'FT',      doj: '04-04-2023', category: 'Support Staff' },
  { sn: 46, name: 'Devraj Panthi',               designation: 'Computer Operator',          qual: 'B.Com',                           type: 'FT',      doj: '06-05-2024', category: 'Support Staff' },
  { sn: 47, name: 'Anmol Malviya',               designation: 'Clerk',                      qual: 'B.Com',                           type: 'FT',      doj: '11-03-2024', category: 'Support Staff' },
  { sn: 48, name: 'Prerna Kuril',                designation: 'MRD Clerk',                  qual: 'B.Com',                           type: 'FT',      doj: '01-12-2025', category: 'Support Staff' },
];

const CATEGORIES = ['All', 'Administration', 'Specialists', 'Medical Officers', 'House Physicians', 'Allied Health', 'Nursing', 'Support Staff'];

const CATEGORY_COLORS = {
  'Administration':   { bg: `${T.gold600}18`, border: `${T.gold600}40`, text: T.gold700 },
